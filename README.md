...
| networkPolicies.egress.from.keystore-job-hook.podSelector.matchLabels.job | string | `"keystore-generator"` |  |
| networkPolicies.egress.from.keystore-job-hook.metadata.annotations."helm.sh/hook" | string | `"pre-install,pre-upgrade"` |  |
| networkPolicies.egress.from.keystore-job-hook.metadata.annotations."helm.sh/hook-weight" | string | `"-5"` |  |
| networkPolicies.egress.from.keystore-job-hook.metadata.annotations."helm.sh/hook-delete-policy" | string | `"before-hook-creation,hook-succeeded"` |  |
| networkPolicies.egress.from.keystore-job-hook.to.definition.kubeAPI | bool | `true` |  |
